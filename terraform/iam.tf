    ...
    Statement = [
      {
        ...
        Condition = {
          ...
          StringLike = {
            "token.actions.githubusercontent.com:sub" = "repo:ismailarici/SecureApp-Pipeline:*"
          }
        }
      }
    ]
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = "arn:aws:ecr:${var.aws_region}:860959037048:repository/${var.project_name}-app"
      },
      {
        Effect = "Allow"
        Action = [
